...
const S = {
  ...
  warningBox: {
    ...
    border: '1px solid var(--detail-warning-border)',
  ...
  lockedPill: {
    border: '1px solid var(--detail-lock-border)',
    background: 'var(--detail-lock-bg)',
    color: 'var(--detail-lock-text)',
    borderRadius: 999,
    padding: '10px 14px',
    fontFamily: 'var(--font-mono)',
    fontSize: '0.68rem',
  ...
  ghostBtn: {
    ...
    border: '1px solid var(--detail-ghost-border)',
