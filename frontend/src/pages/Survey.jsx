...
const cs = {
  ...
  btnNext:  { background:'linear-gradient(135deg,var(--gold),#b8922e)', border:'none', color:'#080c14', padding:'12px 32px', borderRadius:10, fontFamily:'var(--font-display)', fontSize:'0.88rem', fontWeight:700, boxShadow:'0 4px 20px rgba(201,168,76,0.3)', cursor:'pointer' },
  ...
  btnLaunch:{ background:'linear-gradient(135deg,var(--gold),#b8922e)', border:'none', color:'#080c14', padding:'15px 44px', borderRadius:12, fontFamily:'var(--font-display)', fontSize:'0.98rem', fontWeight:700, boxShadow:'0 6px 28px rgba(201,168,76,0.4)', cursor:'pointer' },
}
